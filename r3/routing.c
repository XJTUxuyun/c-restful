...
void test1(void) {
    ...
    //r3_tree_insert_routel(n, METHOD_GET , "/blog/{idl:\\d+}/asf/{id}", strlen("/blog/{idl:\\d+}/asf/{id}"), "get" );
    //r3_tree_insert_routel(n, METHOD_POST, "/blog/{idl:\\d+}/asf/{id}", strlen("/blog/{idl:\\d+}/asf/{id}"), "post");
r3_tree_insert_routel(n, METHOD_POST, "/blog/{idl:\\d+}/asf/{id}", strlen("/blog/{idl:\\d+}/asf/{id}"), "post");
	r3_tree_insert_routel(n, METHOD_PUT, "/blog/{idl:\\d+}/asf/{id}", strlen("/blog/{idl:\\d+}/asf/{id}"), "put");
    ...
    for (int k = 0; k < 1; k++) {
        ...
        if (matched_route) {
             printf("Routed data is: %s\n", (char *)matched_route->data); // get the data from matched route
